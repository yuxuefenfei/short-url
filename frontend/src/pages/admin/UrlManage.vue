<template>
  <div class="url-manage">
    <AdminPageHeader title="短网址管理" subtitle="管理和监控所有短网址" />
        ...
        <template #bodyCell="{ column, record }">
            ...
            <div class="short-url-cell">
              <div class="short-key">
                <a
                  ...
                  target="_blank"
                  @click.prevent="copyUrl(record.shortUrl)"
                >
                  {{ record.shortKey }}
                </a>
              </div>
          ...
          <template v-else-if="column.key === 'originalUrl'">
            <div class="original-url-cell">
              ...
              <div v-if="record.title" class="url-title">
                {{ record.title }}
              </div>
            </div>
          </template>
          ...
          <template v-else-if="column.key === 'clickCount'">
            <div class="click-count-cell">
              ...
              <a class="view-stats" @click="viewStats(record)">查看统计</a>
            </div>
          </template>
          ...
          <template v-else-if="column.key === 'action'">
            <div class="action-cell">
              <a-space>
                ...
                <a-divider type="vertical" />
                <a style="color: #ff4d4f" @click="deleteUrl(record)">删除</a>
              </a-space>
            </div>
          </template>
        </template>
      ...
      <div v-if="selectedUrl" class="detail-content">
        <a-descriptions bordered :column="1">
          ...
          <a-descriptions-item label="过期时间">
            {{
              selectedUrl.expiredTime
                ? formatDateTime(selectedUrl.expiredTime)
                : "永不过期"
            }}
          </a-descriptions-item>
        </a-descriptions>
