<template>
  <div class="user-manage">
    <AdminPageHeader title="用户管理" subtitle="管理系统用户和权限" />
        ...
        <template #bodyCell="{ column, record }">
          ...
          <template v-else-if="column.key === 'lastLoginTime'">
            <div class="time-cell">
              ...
              <div v-if="record.lastLoginTime" class="time-ago">
          ...
          <template v-else-if="column.key === 'action'">
            <div class="action-cell">
              <a-space>
                ...
                <a-divider type="vertical" />
                <a style="color: #fa8c16" @click="resetPassword(record)"
                  >重置密码</a
                >
                <a-divider type="vertical" />
                <a style="color: #ff4d4f" @click="deleteUser(record)">删除</a>
              </a-space>
            </div>
          </template>
        </template>
