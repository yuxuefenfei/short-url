  ...
  <div class="home-page">
    ...
    <main class="page-content">
      <div class="container">
            ...
            <div v-if="result" class="result-section">
              ...
              <div class="result-content">
                <div class="short-url-display">
                  ...
                  <div v-if="result.title" class="url-item">
                  ...
                  <div class="url-item">
                    ...
                    <span class="create-time">{{
                      formatDateTime(result.createdTime)
                    }}</span>
                  </div>
                </div>
                ...
                <div class="action-buttons">
                  ...
                  <a-button
                    type="primary"
                    @click="openShortUrl(result.shortUrl)"
                  >
                    <export-outlined />
                    访问短网址
                  </a-button>
        ...
        <!-- 最近生成的短网址 -->
        <div v-if="hasRecentUrls" class="recent-section">
              ...
              >
                ...
                <div class="item-actions">
                  ...
                  <a-button
                    type="link"
                    size="small"
                    @click="copyToClipboard(item.shortUrl || item.shortKey)"
                  >
                    复制
                  </a-button>
                </div>
